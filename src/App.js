      ...
      <Router>
        <Switch>
         <Route exact path="/"><MainSite/></Route>
          ...
          <PrivateRoute path="/account/job"><JobOffer/></PrivateRoute>
          <PrivateRoute path="/account/events"><Events/></PrivateRoute>
          <PrivateRoute path="/account/announcements"><Announcements/></PrivateRoute>
          <PrivateRoute path="/account/employers"><Employers/></PrivateRoute>
          <PrivateRoute path="/account/emails"><Emails/></PrivateRoute>
          <PrivateRoute path="/account/tasks"><TasksManager/></PrivateRoute>
